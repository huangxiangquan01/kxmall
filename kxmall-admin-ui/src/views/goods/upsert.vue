    ...
    <el-card class="box-card">
      ...
      <el-form ref="dataForm" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="原始价格" prop="originalPriceRaw">
          <el-input v-model="goods.originalPriceRaw" clearable placeholder="0.00">
        ...
        <el-form-item label="商品单位" prop="unit">
          <el-input v-model="goods.unit" clearable placeholder="件 / 个 / 盒" />
        </el-form-item>
        ...
        <el-form-item label="商品简介" prop="description">
          <el-input v-model="goods.description" clearable />
        </el-form-item>
      ...
      <el-dialog :visible.sync="skuVisiable" title="添加商品类型（Sku）">
        ...
        >
          <el-form-item label="类型条码" prop="barCode">
            <el-input v-model="skuForm.barCode" clearable />
          </el-form-item>
          <el-form-item label="类型名称" prop="title">
            <el-input v-model="skuForm.title" clearable />
          </el-form-item>
      ...
      <el-dialog :visible.sync="attributeVisiable" title="设置商品参数">
        ...
        >
          <el-form-item label="商品参数名称" prop="attribute">
            <el-input v-model="attributeForm.attribute" clearable />
          </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      attributes: [],
      skuVisiable: false,
      skuForm: { img: undefined, vipPriceRaw: 0, priceRaw: 0 },
      skuList: [],
      rules: {
        status: [
      ...
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          if (this.goods.freightTemplateId === undefined || this.goods.freightTemplateId === null) {
            ...
            this.goods.categoryId = this.categoryIds[1]
